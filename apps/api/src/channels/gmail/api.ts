...
export async function sendEmail(
  ...
  console.log(`[gmail][send] sending email to: ${params.to}, subject: ${params.subject}`);
  ...
  console.log(`[gmail][send] email sent successfully to: ${params.to}, subject: ${params.subject}`)
