...
} from 'ai/internals/ui-message-stream/ui-message-chunks';

import { mergeObjects } from 'ai/internals/util/merge-objects';

import type { UIDataTypesToSchemas } from 'ai/internals/ui/chat';
