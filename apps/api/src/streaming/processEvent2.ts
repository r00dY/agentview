...
import type { UIMessage, UIMessageStreamError } from "ai";
...
// function processChunk(state: StreamingUIMessageState<UIMessage>, chunk: Awaited<ReturnType<typeof parseChunk>>) : FastPatchOp | undefined {
